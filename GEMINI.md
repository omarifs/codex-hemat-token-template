...
## Purpose
This repository stores reusable prompt templates and operating rules for Gemini CLI.
...
- Prefer direct fixes over exploratory changes.
- Keep edits small and contained.
- Reuse existing templates instead of creating new instruction files unless needed.
